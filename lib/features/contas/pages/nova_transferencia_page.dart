...
class _NovaTransferenciaPageState
  ...
  void initState() {
    ...
    final transferencia = widget.transferencia;
    if (transferencia != null) {
      _contaOrigemId = transferencia.contaOrigemId;
      _contaDestinoId = transferencia.contaDestinoId;
      _data = transferencia.data;
      _valorController.text = transferencia.valor.toStringAsFixed(2).replaceAll('.', ',');
      _descricaoController.text = transferencia.descricao;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.transferencia == null ? 'Nova transferência' : 'Editar transferência'),
      ),
                    ...
                    SizedBox(
                      ...
                      child: FilledButton.icon(
                        ...
                        label: Text(
                          _salvando
                              ? 'Salvando...'
                              : (widget.transferencia == null ? 'Transferir' : 'Salvar alterações'),
                        ),
                      ),
                    ),
                  ],
